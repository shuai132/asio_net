...
int main() {
  ...
  std::thread([] {
    ...
    static rpc_server_ssl server(context, PORT, ssl_context);  // static for test session lifecycle
  ...
  std::thread([] {
    ...
    static rpc_client_ssl client(context, ssl_context);  // static for test session lifecycle
